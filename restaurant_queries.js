...
db.restaurant.find({"grades.score": {$gt: 80, $not: {$gte: 100}}});
...
db.restaurant.find({$and:[{cuisine: "Seafood"}, {$nor:[{cuisine:/^American/},{cuisine:"Chinese"}]},{name: {$not:/^Wil/}}]},{ restaurant_id : 1, name : 1, borough : 1, cuisine : 1});
...
db.restaurant.find({grades: {$elemMatch: {date: ISODate("2014-08-11T00:00:00Z"), grade: "A", score: 11}}},{ restaurant_id : 1, name : 1, grades : 1});
...
db.restaurant.find({$and:[{"address.coord.1": {$gt:42}},{"address.coord.1": {$lte:52}}]},{ restaurant_id : 1, name : 1, address : 1});
...
db.restaurant.find({name: {$regex:"mon", $options: "i" }},{ name : 1, borough : 1, "address.coord" : 1 });
...
db.restaurant.find({name: /^Mad/},{ name : 1, borough : 1, "address.coord" : 1 });
